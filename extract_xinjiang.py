...
# 输入栅格数据和掩膜文件
input_raster_folder = r"C:\Users\r\Desktop\ts_analysis\xinjiang\xinjiang"  # 输入栅格数据路径
mask_shapefile = r"C:\Users\r\Desktop\ts_analysis\province\xinjiang\xinjiang.shp"  # 掩膜矢量文件路径

# 输出文件夹路径
output_raster_folder = r"C:\Users\r\Desktop\ts_analysis\xinjiang\extracted"  # 输出文件夹路径

...
import pandas as pd
# 定义栅格文件路径
tif_file = r"C:\Users\r\Desktop\ts_analysis\sichuan\extracted\extracted_sichuan_idgp_2001.tif"
...
level_1 = ['四川省的土地利用情况'] * len(df.columns)
...
# # 输出 DataFrame 查看
df.to_csv('sichuan_land_use.csv', index=False)

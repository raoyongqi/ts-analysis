...
import pandas as pd
# 定义栅格文件路径
tif_file = r"C:\Users\r\Desktop\ts_analysis\xinjiang\extracted\extracted_xinjiang_idgp_2001.tif"
...
import glob
# 定义栅格文件夹路径
raster_folder = r"C:\Users\r\Desktop\ts_analysis\xinjiang\extracted"
...
level_1 = ['新疆地区的土地利用情况'] * len(df.columns)
